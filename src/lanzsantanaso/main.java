...
public class main {
    ...
    private static void startGuiUpdateTimer() {
    ...
    private static void updateGui() {
        SwingUtilities.invokeLater(() -> {
            ...
            gui.getNetIncomeC().setText(String.valueOf(Apple.getProfits() - Apple.getSalaryAccount()));
            // MSI
            gui.getCosts().setText(String.valueOf(MSI.getSalaryAccount()));
            gui.getRevenue().setText(String.valueOf(MSI.getProfits()));
            gui.getNetIncome().setText(String.valueOf(MSI.getProfits() - MSI.getSalaryAccount()));
            // FAULTS & DEDUCTIONS
            // APPLE
            gui.getProjectManagerFaults().setText(String.valueOf(Apple.getPmFaults()));
            gui.getProjectManagerDeduction().setText(String.valueOf(Apple.getPmDiscountedAmount()));
            // MSI
            gui.getProjectManagerFaultsStar().setText(String.valueOf(MSI.getPmFaults()));
            gui.getProjectManagerDeductionStar().setText(String.valueOf(MSI.getPmDiscountedAmount()));
            // DRIVE AVAILABILITY
            // APPLE
            gui.getScriptAvailability().setText(String.valueOf(MSI.getMotherboardStorage().getMaxResourse() - MSI.getMotherboardStorage().getResourse()));
            gui.getDubbingAvailability().setText(String.valueOf(MSI.getGraphicscardStorage().getMaxResourse() - MSI.getGraphicscardStorage().getResourse()));
            gui.getStageAvailability().setText(String.valueOf(MSI.getRamStorage().getMaxResourse() - MSI.getRamStorage().getResourse()));
            gui.getAnimationAvailability().setText(String.valueOf(MSI.getPowersupplyStorage().getMaxResourse() - MSI.getPowersupplyStorage().getResourse()));
            gui.getPlotTwistAvailability().setText(String.valueOf(MSI.getCpuStorage().getMaxResourse() - MSI.getCpuStorage().getResourse()));
            // MSI
            gui.getScriptAvailabilityC().setText(String.valueOf(Apple.getMotherboardStorage().getMaxResourse() - Apple.getMotherboardStorage().getResourse()));
            gui.getDubbingAvailabilityC().setText(String.valueOf(Apple.getGraphicscardStorage().getMaxResourse() - Apple.getGraphicscardStorage().getResourse()));
            gui.getAnimationAvailabilityC().setText(String.valueOf(Apple.getRamStorage().getMaxResourse() - Apple.getRamStorage().getResourse()));
            gui.getPlotTwistAvailabilityC().setText(String.valueOf(Apple.getPowersupplyStorage().getMaxResourse() - Apple.getPowersupplyStorage().getResourse()));
            gui.getStageAvailabilityC().setText(String.valueOf(Apple.getCpuStorage().getMaxResourse() - Apple.getCpuStorage().getResourse()));
            // READY
            // APPLE
            gui.getReadyPlotTwist().setText(String.valueOf(Apple.getGcAssemblerStorage().getResourse()));
            gui.getReadyStandard().setText(String.valueOf(Apple.getAssemblerStorage().getResourse()));
            // MSI
            gui.getReadyPlotTwistStar().setText(String.valueOf(MSI.getGcAssemblerStorage().getResourse()));
            gui.getReadyStandardStar().setText(String.valueOf(MSI.getAssemblerStorage().getResourse()));
            // DEADLINE COUNTER
            // APPLE
